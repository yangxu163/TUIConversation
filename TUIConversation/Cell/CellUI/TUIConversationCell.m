...
@property (nonatomic, strong) UIImageView *onTopImg;
@end
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _timeLabel.textColor = TUICoreDynamicColor(@"form_desc_color", @"#CCCCCC");
        _timeLabel.layer.masksToBounds = YES;
        [self.contentView addSubview:_timeLabel];
        
        _onTopImg = [[UIImageView alloc] init];
        _onTopImg.image = [UIImage imageNamed:@"consversation_onTop"];
        [self.contentView addSubview:_onTopImg];
        ...
        _subTitleLabel.textColor = TUICoreDynamicColor(@"form_subtitle_color", @"#999999");
...
- (void)fillWithData:(TUIConversationCellData *)convData
{
    ...
    if (convData.isOnTop) {
        self.contentView.backgroundColor = TUIConversationDynamicColor(@"conversation_cell_top_bg_color", @"#F5F5F5");
        self.onTopImg.hidden = false;
    } else {
        self.contentView.backgroundColor = TUIConversationDynamicColor(@"conversation_cell_bg_color", @"#FFFFFF");;
        self.onTopImg.hidden = true;
    }
...
//        UIImage *image = TUIConversationBundleThemeImage(@"conversation_message_not_disturb_img", @"message_not_disturb");
        UIImage *image = [UIImage imageNamed:@"conversation_not_disturb"];
...
- (void)layoutSubviews
{
    ...
    self.onTopImg.mm_width(12).mm_height(12).mm_right(0).mm_top(0);
